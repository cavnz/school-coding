...
// Visual Settings
const PLAYER_SIZE = 50;          // Size of your character (try 20 or 50)
const PLAYER_COLOR = 'rgb(255, 10, 15)';  // Color of player (try 'rgb(231, 76, 60)' or 'rgb(46, 204, 113)')
...
const BACKGROUND_COLOR = 'rgb(15, 100, 35)'; // Color of background (try 'rgb(44, 62, 80)' or 'rgb(26, 26, 26)')
...
// Coin Settings
const NUMBER_OF_COINS = 1000;      // LOTS of coins for maximum juice!
const POINTS_PER_COIN = 250;     // How many points per coin
const COIN_COMPLETION_BONUS = 1000;
const COIN_SIZE = 1;            // Size of coins
